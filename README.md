...
libft/
│
├── libft.h                  # Main header (required at repository root)
├── Makefile                 # Build rules (all, clean, fclean, re, bonus)
├── ft_*.c                   # Mandatory + bonus source files at repository root
├── obj/                     # Object files generated by Makefile
│   ├── ft_isalpha.o
│   ├── ft_strlen.o
│   └── ...
├── libft.a                  # Static library output
├── README.md                # This file
└── .gitignore
```
